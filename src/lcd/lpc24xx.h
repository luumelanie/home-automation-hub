/******************************************************************************
 *   LPC246X.h:  Header file for NXP LPC246x Family Microprocessors
 *   The header file is the super set of all hardware definition of the 
 *   peripherals for the LPC246x family microprocessor.
 *
...
// only LPC247x - LCD controller pin
...
#define LCD_CTRL_BASE  0xFFE10000
#define LCD_TIMH       (*(volatile unsigned long *)(LCD_CTRL_BASE + 0x000))
#define LCD_TIMV       (*(volatile unsigned long *)(LCD_CTRL_BASE + 0x004))
#define LCD_POL        (*(volatile unsigned long *)(LCD_CTRL_BASE + 0x008))
#define LCD_LE         (*(volatile unsigned long *)(LCD_CTRL_BASE + 0x00C))
#define LCD_UPBASE     (*(volatile unsigned long *)(LCD_CTRL_BASE + 0x010))
#define LCD_LPBASE     (*(volatile unsigned long *)(LCD_CTRL_BASE + 0x014))
#define LCD_CTRL       (*(volatile unsigned long *)(LCD_CTRL_BASE + 0x018))
#define LCD_INTMSK     (*(volatile unsigned long *)(LCD_CTRL_BASE + 0x01C))
#define LCD_INTRAW     (*(volatile unsigned long *)(LCD_CTRL_BASE + 0x020))
#define LCD_INTSTAT    (*(volatile unsigned long *)(LCD_CTRL_BASE + 0x024))
#define LCD_INTCLR     (*(volatile unsigned long *)(LCD_CTRL_BASE + 0x028))
#define LCD_UPCURR     (*(volatile unsigned long *)(LCD_CTRL_BASE + 0x02C))
#define LCD_LPCURR     (*(volatile unsigned long *)(LCD_CTRL_BASE + 0x030))
#define LCD_PAL_ADDR   (LCD_CTRL_BASE + 0x200)
#define CRSR_IMG       (*(volatile unsigned long *)(LCD_CTRL_BASE + 0x800))
#define CRSR_CTLR      (*(volatile unsigned long *)(LCD_CTRL_BASE + 0xC00))
#define CRSR_CFG       (*(volatile unsigned long *)(LCD_CTRL_BASE + 0xC04))
#define CRSR_PAL0      (*(volatile unsigned long *)(LCD_CTRL_BASE + 0xC08))
#define CRSR_PAL1      (*(volatile unsigned long *)(LCD_CTRL_BASE + 0xC0C))
#define CRSR_XY        (*(volatile unsigned long *)(LCD_CTRL_BASE + 0xC10))
#define CRSR_CLIP      (*(volatile unsigned long *)(LCD_CTRL_BASE + 0xC14))
#define CRSR_INTMSK    (*(volatile unsigned long *)(LCD_CTRL_BASE + 0xC20))
#define CRSR_INTCLR    (*(volatile unsigned long *)(LCD_CTRL_BASE + 0xC24))
#define CRSR_INTRAW    (*(volatile unsigned long *)(LCD_CTRL_BASE + 0xC28))
#define CRSR_INTSTAT   (*(volatile unsigned long *)(LCD_CTRL_BASE + 0xC2C))
